/**
 * An array of strings representing the different scenarios that can be used in the Mutiny Framework.
 * These scenarios can be used to set the behavior of NPCs in the game.
 */
export const __scenarios = [
  "Standing",
